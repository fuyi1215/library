...
@class TabbedPageDemo_iOS_ExtendedTabbedPageRenderer;
@class Library_iOS_NativeListCell;
@class Xamarin_Forms_Platform_iOS_VisualElementRenderer_1;
@class Xamarin_Forms_Platform_iOS_ViewRenderer_2;
@class Library_iOS_RendererListView;
@class Library_iOS_SettingsListSource;

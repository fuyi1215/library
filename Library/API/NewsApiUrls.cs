...
namespace Library.API
{
	public class NewsApiUrls
	{
		...
		public static readonly string calendar =
            string.Format("https://www.googleapis.com/calendar/v3/calendars/greentownchildrenslib%40gmail.com/events?orderBy=startTime&singleEvents=true&timeMin={0}-{1}-{2}T00%3A00%3A00Z&fields=items&key=AIzaSyD57lAo8C1Ztr5ZgcHVsuyw1rXFyD1scyo"
